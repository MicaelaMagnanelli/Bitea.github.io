...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const getCurrentLanguage = () => {
        ...
        const lang = urlLang && ['es', 'en'].includes(urlLang) ? urlLang : storedLang || 'es';
        console.log('URL lang:', urlLang, 'Stored lang:', storedLang, 'Final lang:', lang);
        return lang;
    };
    ...
    const updateLanguage = (lang) => {
        ...
        document.querySelectorAll('[data-i18n]').forEach(el => {
            ...
            console.log(`Traduciendo ${el.id || el.tagName} con clave "${key}" a "${translation}"`);
