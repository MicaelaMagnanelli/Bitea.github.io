document.addEventListener("DOMContentLoaded", () => {
    ...
    function agregarCupcakePersonalizado() {
        ...
        // 👉 Ajustar posiciones según cantidad actual
        ...
        cupcakes.forEach((cupcake, index) => {
            ...
            // Cuando hay 2 a 4: mover el primero solamente
            if (cupcakeCount >= 2 && cupcakeCount < 5) {
                cupcake.style.left = index === 0 ? '40px' : '40px';
            }

            // Cuando hay 5: mover todos hacia la izquierda progresivamente
            if (cupcakeCount === 5) {
                cupcake.style.left = `${-index * 0}px`; // ejemplo: 0, -20, -40, -60, -80
            }
        });
